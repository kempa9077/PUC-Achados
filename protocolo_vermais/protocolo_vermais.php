...
include '../header.php';
include 'imprimir_protocolo.php';
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <link rel="stylesheet" href="protocolo_vermais.css">
...
<body>
    ...
    <main class="content-area">
        <div class="div-titulo">
            ...
            <p id="titulo"></p>
            <div class="area-x">
                <a id="voltar-home" href="../fun_ver_protocolos/fun_ver_protocolos.php">&times;</a>
            </div>
        </div>
    ...
    <script src="protocolo_vermais.js"></script>
