    ...
    <nav class="second-bar">    
        <div class="menu-nav">
            <div class="divnav">                
                ...
                <a href="../main_descadastrado/main_descadastrado.html" id="pagina_home_sem_cadastro" class="menu-btn">Home</a>
            </div>
            ...
            <div class="divnav">                
                ...
                <a href="../objetos_em_estoque/objetos_em_estoque.html" id="pagina_home_sem_cadastro" class="menu-btn">Objetos em Estoque</a>
            </div>
